      ...
      <div className="doctor-extra-infor-container">
        ...
        <div className="content-down">
            ...
            />
             ...
             <span className="detail" onClick={()=> this.showHideDetailInfor(true)}><FormattedMessage id="patient.extra-infor-doctor.detail" /></span> </div>
            }
          {isShowDetailInfor === true && 
            <>
            <div><FormattedMessage id="patient.extra-infor-doctor.price" /> </div>
